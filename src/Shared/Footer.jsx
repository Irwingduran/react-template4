...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-[#020043] dark:text-white mt-14 lg:py-20">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 ml-0 md:ml-36 lg:ml-64">
        <div className="lg:w-[20%]">
          ...
          <h1 className="text-4xl">Dr Omar Espinosa Gonzalez</h1>
            <p className="text-lg lg:-ml-10 mt-4 font-barlow">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 w-full lg:w-2/3 lg:grid-cols-4 font-semibold lg:mr-40">
          ...
          <div className="space-y-3 lg:ml-20">
            <ul className="space-y-1 text-lg">
              <li>
                <a rel="noopener noreferrer" href="https://wa.me/5212221843622?text=Hola%20Dr.%20encontr%C3%A9%20su%20perfil%20en%20findoctor%20y%20me%20gustar%C3%ADa%20realizar%20una%20consulta" target="_blank">
                  Agendar Cita
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="https://maps.app.goo.gl/BVu57wNRpgDragLt6" target="_blank"> 
                  Ubicación
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3 lg:ml-40 lg:w-[200px]">
            <div className="uppercase">Sígueme</div>
      ...
      <a href="https://delta-digital.com.mx/" >Delta Agency &copy;  2025 </a></p>
      </div>
    </footer>
  );
};
